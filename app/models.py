...
class CertificateType(db.Model):
    ...
    # MedLocum designed certificate mode: 'mlj' renders the branded MedLocum
    # certificate (no template upload needed); 'overlay'/'svg' personalize an
    # uploaded master template.
